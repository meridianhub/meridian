...
-- Comment on table
COMMENT ON TABLE event_outbox IS 'Transactional outbox for reliable event delivery. Events are written atomically with business operations and processed by background worker.';
