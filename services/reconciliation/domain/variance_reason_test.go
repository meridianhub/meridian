...
func TestVarianceReason_IsValid(t *testing.T) {
	tests := []struct {
		...
		{"valid quality upgrade", VarianceReasonQualityUpgrade, true},
		{"valid external mismatch", VarianceReasonExternalMismatch, true},
		{"valid correction applied", VarianceReasonCorrectionApplied, true},
