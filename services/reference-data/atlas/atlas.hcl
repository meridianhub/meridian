// Atlas configuration for Reference Data Service
// BIAN Service Domain: Reference Data
// Instrument definitions and reference data management
...
env "local" {
  ...
  migration {
    dir = "file://services/reference-data/migrations"
  }
...
env "production" {
  ...
  // URL points to service-specific database (meridian_reference_data)
