...
# Version: 1.5.0
# Previous: 1.4.0
# Changed: Supersedes broken v1.4.0 (which called nonexistent update handlers).
#          Same idempotent register+activate logic as v1.3.0. Bumped to v1.5.0
#          because the bootstrap skips existing (name, version) pairs - v1.4.0
#          is already in the DB with broken script content.
