...
--
-- Note: COMMENT ON INDEX omitted because CockroachDB requires table-qualified
-- syntax (table@index) which is not PostgreSQL-compatible.
...
CREATE INDEX IF NOT EXISTS idx_data_source_cursor
...
-- Supports ORDER BY created_at DESC, id DESC
CREATE INDEX IF NOT EXISTS idx_dataset_definition_cursor
...
CREATE INDEX IF NOT EXISTS idx_market_price_observation_cursor
