...
//
// Run with: go test -bench=. -benchmem ./services/internal-bank-account/benchmarks/
// Run load tests: go test -run=Test -v ./services/internal-bank-account/benchmarks/
...
// This tests parallel RetrieveInternalBankAccount calls.
