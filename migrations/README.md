...
- `atlas/financial_accounting.hcl` - Financial Accounting schema config
- `atlas/payment_order.hcl` - Payment Order schema config
- `atlas/shared.hcl` - Shared audit factory schema config
