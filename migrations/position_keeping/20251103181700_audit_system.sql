...
CREATE TABLE IF NOT EXISTS position_keeping_audit.audit_outbox (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_audit_outbox_status_created ON position_keeping_audit.audit_outbox(status, created_at);
